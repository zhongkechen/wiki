...
* [1.1 Getting Started 入门](<1.01_Getting_Started.qmd>)
* [1.2 Variables and Arithmetic Expressions 变量与算术表达式](<1.02_Variables_and_Arithmetic_Expressions.qmd>)
* [1.3 The for statement for语句](<1.03_The_for_statement.qmd>)
* [1.4 Symbolic Constants 符号常量](<1.04_Symbolic_Constants.qmd>)
* [1.5 Character Input and Output 字符输入输出](<1.05_Character_Input_and_Output.qmd>)
* [1.6 Arrays 数组](<1.06_Arrays.qmd>)
* [1.7 Functions 函数](<1.07_Functions.qmd>)
* [1.8 Arguments - Call by Value 参数——传值调用](<1.08_Arguments_-_Call_by_Value.qmd>)
* [1.9 Character Arrays 字符数组](<1.09_Character_Arrays.qmd>)
* [1.10 External Variables and Scope 外部变量与作用域](<1.10_External_Variables_and_Scope.qmd>)
