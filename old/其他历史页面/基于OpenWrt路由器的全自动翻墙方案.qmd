...
* 安装iptables nat-extra、geoip和u32模块。
  ...
  ```
* 生成IP国家信息数据库。在某台Mac或者Linux上下载并解压缩[[http://sourceforge.net/projects/xtables-addons/files/|xtables-addons源码]，然后按照[这篇文档](http://www.howtoforge.com/xtables-addons-on-centos-6-and-iptables-geoip-filtering)的步骤生成IP数据库。如果不介意较老的数据库，可以直接从[这里](http://ch3n2k.com/~czk/CNgeoip.tar.gz)下载一个生成好的。
